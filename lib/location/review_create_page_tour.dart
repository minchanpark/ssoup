...
class ReviewCreatePageTour extends StatefulWidget {
  ...
  ReviewCreatePageTour({super.key, required this.courseId});

  @override
  State<ReviewCreatePageTour> createState() => _ReviewCreatePageState();
}

class _ReviewCreatePageState extends State<ReviewCreatePageTour> {
