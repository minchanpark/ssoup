        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                "제1조(목적)\n"
                "ssoup(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 "
                "이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, "
                "개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 "
                "법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 "
                "있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.",
              ...
              Text(
                "제3조(본 방침의 공개)\n"
                "  1. 회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 회사 홈페이지 첫 화면 또는 "
              ...
              Text(
                ...
                "  5. 신규 서비스 개발을 위한 경우\n"
                "  6. 서비스 사용자 각자에게 별도의 기능을 제공하기 위함",
                style: TextStyle(fontSize: 16),
              ),
              SizedBox(height: 20),
              Text(
                "제8조(개인정보의 보유 및 이용기간)\n"
                "  1. 회사는 이용자의 개인정보에 대해 개인정보의 수집·이용 목적 달성을 위한 기간 동안 "
                "개인정보를 보유 및 이용합니다.\n"
                "  2. 전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용 방지를 "
              ...
              Text(
                "제11조(개인정보파기절차)\n"
                "이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된 후 별도의 DB로 옮겨져 "
                "(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라 "
                "(보유 및 이용기간 참조) 일정 기간 저장된 후 파기 되어집니다.\n"
              ...
              Text(
                ...
                "명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다.\n"
                "  1. 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우, 거래가 종료된 날로부터 "
                "6개월 이내에 회사가 처리하고 수신자와 거래한 것과 동종의 재화 등에 대한 영리목적의 광고성 정보를 "
                "전송하려는 경우\n"
                "  2. 「방문판매 등에 관한 법률」에 따른 전화권유판매자가 육성으로 수신자에게 개인정보의 "
                ...
                "광고성 정보를 전송하는 경우에는 제1항에도 불구하고 그 수신자로부터 별도의 사전 동의를 받습니다.\n"
                "  4. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음의 사항 등을 "
                "광고성 정보에 구체적으로 밝힙니다.\n"
                "  가. 회사명 및 연락처\n"
              ...
              Text(
                "제20조(해킹 등에 대비한 대책)\n"
                "  1. 회사는 해킹, 컴퓨터 바이러스 등 정보통신망 침입에 의해 이용자의 개인정보가 유출되거나 "
