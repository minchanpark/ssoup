...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<bool> checkNickname(User user) async {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('*이름', style: medium15.copyWith(fontWeight: FontWeight.w500)),
            TextField(
            ...
            const SizedBox(height: 16),
            Text('*이메일', style: medium15.copyWith(fontWeight: FontWeight.w500)),
            TextField(
